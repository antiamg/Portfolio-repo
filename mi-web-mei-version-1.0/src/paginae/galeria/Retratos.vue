...
const retratos = computed(() =>
  detalles.filter(d => d.categoria === "retratos")
)
...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 p-10">

  <div>
    <img src="/imagines/titulo-retratos.png" alt="" class="mt-10">
  </div>
  <div
  v-for="obra in retratos"
  :key="obra.id"
