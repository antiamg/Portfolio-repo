...
const diseno = computed(() =>
  detalles.filter(d => d.categoria === "diseno")
)
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-10">
  ...
  <div>
    <img src="/imagines/titulo-diseno.png" alt="" class="mt-10">
  </div>
  <div
  ...
  <div class="relative w-full aspect-square overflow-hidden rounded-xl">
    ...
    <!-- overlay -->
    <div class="absolute inset-0 opacity-0 group-hover:opacity-90 transition flex items-center justify-center bg-[url('/imagines/fondo-rosa.png')] h-full w-full object-cover bg-cover bg-center">
